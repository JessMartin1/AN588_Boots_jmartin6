---
title: "AN588 Final Homework 5 (Fall 2023)"
author: "Jess Martin"
date: "`11/17/2023`"
output: 
  html_document:
...
* Again, our code is pretty much identical which makes sense since we used the same reference site, lol. 

* Great job! This homework was pretty straight forward thankfully. :)

# My Experience with Homework #5

**One thing that I found difficult about this assignment:**

1. Nothing to note here! This assignment was relatively uncomplicated.

**Two things that I liked from my peer's comments:**

1. It's cool that we both used the same website and ended up with almost the exact same codes. Small world!
2. So complimentary!

**One thing I think could have used improvement from my peer's comments:**

1. Nothing, my peer's comments were LOVELY!